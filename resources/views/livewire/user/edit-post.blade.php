...
<div class="w-4/5 mx-auto px-6 py-4 bg-white shadow-xl overflow-hidden rounded-lg">
    <div class="h-fit">
        <form>
            @csrf
            ...
            <div class="col-span-6 sm:col-span-4">
                <livewire:component.pictures-area :post="$post" />
            </div>
            ...
            <!-- Tags -->
            <div class="col-span-6 sm:col-span-4 mt-4">
                <livewire:component.tags-area :post="$post" />
            </div>
